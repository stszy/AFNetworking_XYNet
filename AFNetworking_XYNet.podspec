...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AFNetworking_XYNet.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/songzy1989@163.com/AFNetworking_XYNet'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'songzy1989@163.com' => 'songzy1989@163.com' }
  s.source           = { :git => 'https://github.com/songzy1989@163.com/AFNetworking_XYNet.git', :tag => s.version.to_s }
